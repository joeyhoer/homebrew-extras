cask "font-microsoft-office" do
  ...
  # business.uwm.edu/gdrive/Dietenberger_E/PowerPointViewer.exe was verified as official when first introduced to the cask
  url "http://www.business.uwm.edu/gdrive/Dietenberger_E/PowerPointViewer.exe"
  name "PowerPoint Fonts"
